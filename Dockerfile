...
ARG NEXT_PUBLIC_META_PIXEL_ID_HOME=
ENV NEXT_PUBLIC_META_PIXEL_ID_HOME=$NEXT_PUBLIC_META_PIXEL_ID_HOME
ARG NEXT_PUBLIC_META_PIXEL_ID_TELECOM=
ENV NEXT_PUBLIC_META_PIXEL_ID_TELECOM=$NEXT_PUBLIC_META_PIXEL_ID_TELECOM
