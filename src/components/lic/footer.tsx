    ...
    <footer className="bg-zinc-950 text-zinc-400 py-14 md:py-16 border-t border-white/5">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="space-y-4 text-center mb-8">
          ...
          <p className="text-base text-zinc-500">WhatsApp • E-mail • @igreenenergy</p>
          {onCTAClick && (
            <div className="pt-4 flex flex-col sm:flex-row gap-3 justify-center items-center">
              ...
              <button
                type="button"
                onClick={onCTAClick}
                className="inline-flex h-12 px-8 items-center justify-center rounded-xl border border-primary/60 text-primary text-base font-bold hover:bg-primary/10 transition-colors"
              >
        ...
        <div className="pt-8 border-t border-white/5 text-center text-sm space-y-3 text-zinc-500">
