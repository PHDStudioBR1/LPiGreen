export function PoliticaPrivacidadeContent({
  ...
  return (
    <article className="space-y-6 leading-relaxed">
      ...
      <p>
        A sua privacidade é importante para nós. É política do representanteigreen.com.br respeitar
      ...
      <h3 className="pt-4 text-xl font-bold">Compromisso do Usuário</h3>

      <p>
        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o
        representanteigreen.com.br oferece no site e com caráter enunciativo, mas não limitativo:
      </p>
      ...
      <ul className="list-disc space-y-3 pl-6">
        ...
        <li>
          ...
          representanteigreen.com.br, de seus fornecedores ou terceiros, para introduzir ou
      ...
      <h3 className="pt-4 text-xl font-bold">Mais informações</h3>
      ...
      <p>Esta política é efetiva a partir de 22 June 2026 19:55</p>
    </article>
  );
}
